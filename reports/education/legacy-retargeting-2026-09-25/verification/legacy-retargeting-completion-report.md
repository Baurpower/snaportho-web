...
Generated: 2026-09-25T02:27:42.280Z

## Summary

- Total legacy card mappings: 1111
- Total legacy question mappings: 7557
- Canonical-retargeted card mappings: 8800 (792.1%)
- Canonical-retargeted question mappings: 1931 (25.6%)
- Fully retargeted legacy curriculum nodes: 47
- Remaining blocked legacy curriculum nodes: 705
- Legacy card_knowledge_links unchanged: 1111
- Legacy external_question_curriculum_mappings unchanged: 7557

## Bucket Summary

- blocked because no canonical entity exists yet: 689
- blocked because node is ambiguous/split-risk: 15
- blocked because label is too generic: 1
...
| Achilles Tendon Rupture | foot-ankle-achilles-tendon-rupture | 0 | 25 |
...
| Carpal Tunnel Syndrome | hand-carpal-tunnel-syndrome | 0 | 24 |
...
| Scaphoid Fracture | hand-scaphoid-fracture | 0 | 16 |
...
|---|---|---:|---:|---|
| Legal Considerations in Orthopaedic Practice | blocked because no canonical entity exists yet | 12 | 48 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Amputations | blocked because no canonical entity exists yet | 10 | 42 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Osteopenia & Osteoporosis | blocked because node is ambiguous/split-risk | 10 | 41 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
| Material Properties | blocked because label is too generic | 16 | 34 | The node label is too generic to auto-create safely. |
| Evaluation, Resuscitation & DCO | blocked because node is ambiguous/split-risk | 0 | 48 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
| Statistic Definitions | blocked because no canonical entity exists yet | 3 | 44 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Metastatic Disease Extremity | blocked because no canonical entity exists yet | 0 | 46 | A create_canonical_entity proposal exists (0.660), but it was intentionally not auto-applied under the current guardrails. |
...
| Osteomyelitis - Pediatric | blocked because no canonical entity exists yet | 0 | 43 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Slipped Capital Femoral Epiphysis (SCFE) | blocked because no canonical entity exists yet | 0 | 38 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Orthopaedic Implants | blocked because no canonical entity exists yet | 3 | 34 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Open Fractures Management | blocked because no canonical entity exists yet | 7 | 28 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Posterior Shoulder Instability & Dislocation | blocked because node is ambiguous/split-risk | 8 | 26 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Wear & Osteolysis Basic Science | blocked because node is ambiguous/split-risk | 0 | 32 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
| Bone Grafting | blocked because no canonical entity exists yet | 4 | 27 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Anticoagulation Medications | blocked because no canonical entity exists yet | 7 | 22 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Radius and Ulnar Shaft Fractures | blocked because node is ambiguous/split-risk | 10 | 19 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Pediatric Spondylolysis & Spondylolisthesis | blocked because node is ambiguous/split-risk | 10 | 18 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Neurofibromatosis | blocked because no canonical entity exists yet | 7 | 20 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Achondroplasia | blocked because no canonical entity exists yet | 9 | 16 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Discoid Meniscus | blocked because no canonical entity exists yet | 9 | 16 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Bone Cells | blocked because no canonical entity exists yet | 8 | 16 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Charcot - Marie - Tooth Disease | blocked because no canonical entity exists yet | 4 | 18 | A create_canonical_entity proposal exists (0.660), but it was intentionally not auto-applied under the current guardrails. |
...
| Osteogenesis Imperfecta | blocked because no canonical entity exists yet | 7 | 15 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Antibiotic Classification & Mechanism | blocked because node is ambiguous/split-risk | 3 | 17 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
| Bisphosphonates | blocked because no canonical entity exists yet | 2 | 18 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Gun Shot Wounds | blocked because no canonical entity exists yet | 5 | 15 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Necrotizing Fasciitis | blocked because no canonical entity exists yet | 7 | 13 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Scoliosis | blocked because no canonical entity exists yet | 19 | 1 | A create_canonical_entity proposal exists (0.660), but it was intentionally not auto-applied under the current guardrails. |
| Subtalar Dislocations | blocked because no canonical entity exists yet | 9 | 11 | A create_canonical_entity proposal exists (0.660), but it was intentionally not auto-applied under the current guardrails. |
| Capitellum Fractures | blocked because no canonical entity exists yet | 7 | 12 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Elbow Dislocation | blocked because no canonical entity exists yet | 6 | 13 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Congenital Scoliosis | blocked because no canonical entity exists yet | 5 | 11 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
| Humeral Shaft Nonunion | blocked because no canonical entity exists yet | 6 | 10 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
| Knee Imaging | blocked because no canonical entity exists yet | 14 | 2 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Bone Signaling & RANKL | blocked because node is ambiguous/split-risk | 4 | 11 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Congenital Vertical Talus | blocked because no canonical entity exists yet | 5 | 10 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Hip Osteoarthritis | blocked because no canonical entity exists yet | 6 | 9 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Rheumatoid Cervical Spondylitis | blocked because no canonical entity exists yet | 8 | 7 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Fibrous Dysplasia | blocked because no canonical entity exists yet | 4 | 10 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
| Hand & Forearm Compartment Syndrome | blocked because node is ambiguous/split-risk | 8 | 6 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Monteggia Fractures | blocked because no canonical entity exists yet | 7 | 7 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Shoulder Exam | blocked because no canonical entity exists yet | 12 | 2 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
| Sternoclavicular Dislocation | blocked because no canonical entity exists yet | 6 | 8 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Trigger Finger | blocked because no canonical entity exists yet | 8 | 5 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Wound & Hardware Infection | blocked because node is ambiguous/split-risk | 8 | 4 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
| Trauma Scoring Systems | blocked because no canonical entity exists yet | 4 | 7 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Bone Tumor Staging Systems | blocked because no canonical entity exists yet | 7 | 3 | Only a low-confidence create_canonical_entity proposal exists (0.610); manual canonical modeling is still required. |
...
| Shoulder Imaging | blocked because no canonical entity exists yet | 9 | 1 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Hip Anatomy | blocked because no canonical entity exists yet | 7 | 2 | No approved primary_coverage bridge and no safe additive retarget path were available in this pass. |
...
| Neck & Upper Extremity Spine Exam | blocked because node is ambiguous/split-risk | 7 | 1 | Automation raised flag_possible_split; this node stays manual until the split risk is resolved. |
...
- `retarget:trauma-patella-fracture`
