# Femoral Neck Fracture (Adult Recon Perspective) — Strict Database Verification Blocked
...
- `bridge|adult-recon-femoral-neck-fracture|femoral-neck-fracture-adult-recon`: bridge_endpoint_cardinality; expected one curriculum node adult-recon-femoral-neck-fracture and one entity femoral-neck-fracture-adult-recon; observed 0 node(s), 1 entity row(s).
