# Knee Osteoarthritis — Strict Database Verification Blocked
...
- `bridge|adult-recon-knee-osteoarthritis|knee-osteoarthritis`: bridge_endpoint_cardinality; expected one curriculum node adult-recon-knee-osteoarthritis and one entity knee-osteoarthritis; observed 0 node(s), 1 entity row(s).
