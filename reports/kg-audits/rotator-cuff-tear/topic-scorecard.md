# ROTATOR CUFF TEAR — Knowledge Factory Audit

Generated: 2026-07-05T23:23:33.757Z
...
- **Evidence:** 0 outbound injured_in edges from rotator-cuff-tear
...
- **Impact:** -15
- **Fix:** [high] Rotator Cuff Tear Classification neighborhood has 0/2 classification_grade entities.

### [HIGH] 5 orphan entities with no relationships

- **Evidence:** Slugs: ac-joint, axillary-nerve, elbow-joint, proximal-humerus, upper-extremity-trauma-anatomy-hub
...
### [HIGH] 5 disconnected anatomy structures

- **Evidence:** Disconnected: ac-joint, axillary-nerve, elbow-joint, proximal-humerus, upper-extremity-trauma-anatomy-hub
...
- **Evidence:** 0 outbound at_risk_structure edges from rotator-cuff-tear
- **Reason:** Core diagnosis neighborhoods require standard clinical relationship patterns.
- **Impact:** -8
...
5. **[Publication Readiness]** [high] Rotator Cuff Tear Classification neighborhood has 0/2 classification_grade entities. — _5 critical/high ontology gaps remain unresolved_
6. **[Graph Integrity]** Add inbound or outbound clinical/anatomy edges, or merge duplicates. — _5 orphan entities with no relationships_
7. **[Graph Integrity]** Add involves_anatomy, injured_in, or part_of edges from condition/procedure anchors. — _5 disconnected anatomy structures_
