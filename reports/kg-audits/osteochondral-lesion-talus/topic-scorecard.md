# OSTEOCHONDRAL LESION OF THE TALUS — Knowledge Factory Audit

Generated: 2026-07-05T23:23:33.774Z
...
- **Evidence:** 0/96 proposals have evidence_refs
...
- **Evidence:** 0 outbound injured_in edges from osteochondral-lesion-talus
...
- **Impact:** -15
- **Fix:** [high] Osteochondral Lesion of the Talus Classification neighborhood has 0/2 classification_grade entities.

### [HIGH] 3 orphan entities with no relationships

- **Evidence:** Slugs: deltoid-ligament, lateral-malleolus, medial-malleolus
...
### [HIGH] 3 disconnected anatomy structures

- **Evidence:** Disconnected: deltoid-ligament, lateral-malleolus, medial-malleolus
...
- **Evidence:** 0 outbound at_risk_structure edges from osteochondral-lesion-talus
- **Reason:** Core diagnosis neighborhoods require standard clinical relationship patterns.
- **Impact:** -8
...
5. **[Publication Readiness]** [high] Osteochondral Lesion of the Talus Classification neighborhood has 0/2 classification_grade entities. — _5 critical/high ontology gaps remain unresolved_
6. **[Graph Integrity]** Add inbound or outbound clinical/anatomy edges, or merge duplicates. — _3 orphan entities with no relationships_
7. **[Graph Integrity]** Add involves_anatomy, injured_in, or part_of edges from condition/procedure anchors. — _3 disconnected anatomy structures_
