# PATELLA FRACTURE — Knowledge Factory Audit

Generated: 2026-07-16T03:33:40.561Z
...
- **Evidence:** ontology-gap-report.json: gap-entity-neighbor-1, gap-rel-4, gap-rel-7
...
- **Evidence:** 0/60 proposals have evidence_refs
...
- **Evidence:** 0 outbound has_classification edges from patella-fracture
...
- **Impact:** -15
- **Fix:** [critical] Patella Fracture neighborhood has 0/3 anatomy_structure entities.
...
### [HIGH] Missing relationship requirements (11)

- **Evidence:** 11 gaps of kind missing_relationship
...
6. **[Publication Readiness]** [critical] Patella Fracture neighborhood has 0/3 anatomy_structure entities. — _18 critical/high ontology gaps remain unresolved_
7. **[Ontology Completeness]** Schedule gap-resolution work items from ontology-work-plan.json. — _9 high-priority ontology gaps_
8. **[Ontology Completeness]** Run the matching builder agent for missing_relationship. — _Missing relationship requirements (11)_
