# KNEE INSTABILITY AFTER TKA — Knowledge Factory Audit

Generated: 2026-07-16T02:53:49.243Z
...
- **Evidence:** ontology-gap-report.json: gap-rel-15, gap-rel-17, gap-rel-19
...
- **Evidence:** 0 outbound injured_in edges from knee-instability-after-tka
...
- **Evidence:** 0 outbound has_classification edges from knee-instability-after-tka
- **Reason:** Core diagnosis neighborhoods require standard clinical relationship patterns.
- **Impact:** -15
...
### [HIGH] 10 high-priority ontology gaps
...
### [HIGH] Missing relationship requirements (15)

- **Evidence:** 15 gaps of kind missing_relationship
...
6. **[Publication Readiness]** [high] Adult Reconstruction Anatomy Hub missing outbound part_of (0/1). — _18 critical/high ontology gaps remain unresolved_
7. **[Ontology Completeness]** Schedule gap-resolution work items from ontology-work-plan.json. — _10 high-priority ontology gaps_
8. **[Ontology Completeness]** Run the matching builder agent for missing_relationship. — _Missing relationship requirements (15)_
