...
Topic: **Pilon Fracture** (`pilon-fracture`)
Packet ID: `ev-packet-07c359c5`
Generated: 2026-07-05T22:45:31.073Z
...
- **anki_card**: 5 mapping(s) → pilon-fracture (metadataOnly=true)
- **orthobullets_question**: 27 mapping(s) → pilon-fracture (metadataOnly=true)
...
- [info] CASEPREP_LINK_MISSING: No CasePrep mapping for topic pilon-fracture
