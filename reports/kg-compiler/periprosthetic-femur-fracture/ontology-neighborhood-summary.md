...
Generated: 2026-07-05T22:49:07.653Z
...
| Human review queue | 9 (14.1%) |
| Maturity | Level 5 / 7 required |
| Publication ready | **no** |

## Pipeline stages

- **Stage 1 — Neighborhood Resolution** (completed): Resolved 3 entities from canonical DB for Periprosthetic Femur Fracture.
...
- **[critical]** missing_entity: Periprosthetic Femur Fracture neighborhood has 0/3 anatomy_structure entities. _(rule: condition.anatomy.min_structures, reviewer: clinical_expert)_
...
- **[high]** missing_relationship: Periprosthetic Femur Fracture missing outbound involves_anatomy (0/1). _(rule: condition.pred.involves_anatomy, reviewer: curator)_
...
- **[critical]** missing_relationship: Periprosthetic Femur Fracture missing outbound has_imaging_finding (0/1). _(rule: condition.pred.has_imaging_finding, reviewer: clinical_expert)_
- **[medium]** missing_relationship: Periprosthetic Femur Fracture missing outbound has_complication (0/1). _(rule: condition.pred.has_complication, reviewer: none)_
- **[high]** missing_relationship: Periprosthetic Femur Fracture missing outbound treated_by (0/1). _(rule: condition.pred.treated_by, reviewer: curator)_
- **[high]** missing_relationship: Periprosthetic Femur Fracture missing inbound prerequisite_for (0/1). _(rule: condition.pred.prerequisite_for_inbound, reviewer: curator)_
- **[high]** missing_claim: Periprosthetic Femur Fracture has 0/3 L1 claims. _(rule: condition.claims.l1, reviewer: curator)_
