...
Topic: **imaging-radiographic-measurements**
Framework: **1.0.0**
...
- Gap-resolution assignments: 2
- Unmet gap capabilities: 0

## Assignments

- **Relationship Builder** (relationship-builder): 47 gap(s) [missing_relationship] — handles_gap_kind:missing_relationship
- **Claim Builder** (claim-builder): 137 gap(s) [missing_claim] — handles_gap_kind:missing_claim
