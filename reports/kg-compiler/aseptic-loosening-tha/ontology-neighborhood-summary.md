...
Generated: 2026-07-05T22:53:45.345Z
...
| Auto-approved | 74 (86%) |
| Human review queue | 12 (14%) |
| Maturity | Level 5 / 7 required |
| Publication ready | **no** |

## Pipeline stages

- **Stage 1 — Neighborhood Resolution** (completed): Resolved 3 entities from canonical DB for Aseptic Loosening of THA.
...
- **Stage 6 — Merge** (completed): Merged draft: 64 entities, 8 relationships; 1 conflicts.
- **Stage 7 — Intelligent Auto Review** (completed): 86% auto-approved; 14% escalated.
...
- **[critical]** missing_entity: Aseptic Loosening of THA neighborhood has 0/3 anatomy_structure entities. _(rule: condition.anatomy.min_structures, reviewer: clinical_expert)_
...
- **[high]** missing_relationship: Aseptic Loosening of THA missing outbound involves_anatomy (0/1). _(rule: condition.pred.involves_anatomy, reviewer: curator)_
...
- **[high]** missing_relationship: Aseptic Loosening of THA missing inbound prerequisite_for (0/1). _(rule: condition.pred.prerequisite_for_inbound, reviewer: curator)_
