...
Generated: 2026-07-16T02:54:52.456Z
...
- **Stage 1 — Neighborhood Resolution** (completed): Resolved 8 entities from canonical DB for Periprosthetic Knee Fracture.
- **Stage 2 — Ontology Requirement Expansion** (completed): Derived requirements from CKO spec §8–§9 and anatomy ontology plan.
- **Stage 3 — Gap Analysis** (completed): Identified 26 gaps across 5 kinds.
...
- **[critical]** missing_entity: Periprosthetic Knee Fracture neighborhood has 1/3 anatomy_structure entities. _(rule: condition.anatomy.min_structures, reviewer: clinical_expert)_
