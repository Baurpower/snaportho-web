...
- **Clinical Entity Builder** (clinical-entity-builder): 10 gap(s) [missing_entity] — handles_gap_kind:missing_entity; generic_fallback
- **Relationship Builder** (relationship-builder): 29 gap(s) [missing_relationship] — handles_gap_kind:missing_relationship
