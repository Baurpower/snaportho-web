# Ontology Compiler — Hip Osteoarthritis

Generated: 2026-07-05T22:44:52.319Z
...
| Human review queue | 12 (13.8%) |
| Maturity | Level 5 / 7 required |
| Publication ready | **no** |

## Pipeline stages

- **Stage 1 — Neighborhood Resolution** (completed): Resolved 15 entities from canonical DB for Hip Osteoarthritis.
- **Stage 2 — Ontology Requirement Expansion** (completed): Derived requirements from CKO spec §8–§9 and anatomy ontology plan.
- **Stage 3 — Gap Analysis** (completed): Identified 58 gaps across 6 kinds.
...
- **Stage 6 — Merge** (completed): Merged draft: 32 entities, 36 relationships; 1 conflicts.
...
- **[medium]** missing_claim: Bearing Surface Selection missing claim type: anatomy_pearl. _(rule: biomechanics.claims.anatomy_pearl, reviewer: none)_
- **[critical]** missing_entity: Adverse Local Tissue Reaction neighborhood has 0/1 anatomy_structure entities. _(rule: procedure.anatomy, reviewer: clinical_expert)_
- **[critical]** missing_relationship: Adverse Local Tissue Reaction missing outbound involves_anatomy (0/1). _(rule: procedure.pred.involves_anatomy, reviewer: clinical_expert)_
...
- **[critical]** missing_entity: Unicompartmental Knee Arthroplasty neighborhood has 0/1 anatomy_structure entities. _(rule: procedure.anatomy, reviewer: clinical_expert)_
- **[critical]** missing_relationship: Unicompartmental Knee Arthroplasty missing outbound involves_anatomy (0/1). _(rule: procedure.pred.involves_anatomy, reviewer: clinical_expert)_
