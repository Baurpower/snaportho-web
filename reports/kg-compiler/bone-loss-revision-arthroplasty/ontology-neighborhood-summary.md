...
| Human review queue | 8 (11.4%) |
| Maturity | Level 5 / 8 required |
| Publication ready | **no** |

## Pipeline stages

- **Stage 1 — Neighborhood Resolution** (completed): Resolved 7 entities from canonical DB for Bone Loss in Revision Arthroplasty.
...
- **Stage 6 — Merge** (completed): Merged draft: 66 entities, 11 relationships; 0 conflicts.
...
- **[high]** missing_entity: AORI Classification neighborhood has 0/2 classification_grade entities. _(rule: classification.grades, reviewer: curator)_
- **[critical]** missing_entity: Bone Loss in Revision Arthroplasty neighborhood has 1/3 anatomy_structure entities. _(rule: condition.anatomy.min_structures, reviewer: clinical_expert)_
...
- **[high]** missing_claim: Bone Loss in Revision Arthroplasty has 0/3 L1 claims. _(rule: condition.claims.l1, reviewer: curator)_
