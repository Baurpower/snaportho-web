...
Framework: **1.0.0**
Generated: 2026-07-16T02:46:42.113Z
...
- **Relationship Builder** (relationship-builder): 16 gap(s) [missing_relationship] — handles_gap_kind:missing_relationship
...
- **Metadata Builder** (metadata-builder): 5 gap(s) [missing_metadata] — handles_gap_kind:missing_metadata
