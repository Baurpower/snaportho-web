...
export function StudentWorkspaceProgressOverview({
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
      <div className="bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.2),transparent_26%),linear-gradient(135deg,#020617_0%,#0f172a_62%,#172554_100%)] px-5 py-5 text-white sm:px-6 sm:py-6">
        <div className="grid gap-4 xl:grid-cols-[1.5fr_0.9fr] xl:items-start">
              ...
              <div className="min-w-0">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <Link
                    ...
                    className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-slate-100"
                  >
                    Review today&apos;s plan
                ...
                <div className="grid gap-2">
                  {compactMetrics.map((metric) => {
                    ...
                    return (
                      <div
                        key={metric.label}
                        className="flex items-center justify-between gap-3 rounded-full border border-white/10 bg-white/5 px-3.5 py-2"
                      >
...
function JourneyPanel({
  ...
  return (
    <div className="rounded-[1.35rem] border border-white/10 bg-white/5 px-4 py-3 backdrop-blur">
