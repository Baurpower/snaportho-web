...
const framework = [
  { number: '01', title: 'Search Broadly', question: 'Where should you look?', body: 'Search more than one source because database coverage and indexing differ. Combine PubMed, Scopus, Google Scholar, Cochrane, reference lists, and conference proceedings when appropriate to reduce blind spots.', detail: 'Multiple databases make it less likely that terminology, indexing, or publication type hides an important study.' },
