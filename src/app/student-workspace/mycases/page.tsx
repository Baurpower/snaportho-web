...
export default async function StudentMyCasesPage({searchParams}:{searchParams?:Promise<{preview?:string}>}) {
  ...
  if(preview)return <StudentWorkspaceChrome badge="MyCases" title="MyCases" description="Review cases and turn experience into reusable learning." compactOnMobile><MyCasesWorkspace initialCases={MYCASES_CASE_FIXTURES} initialItems={MYCASES_LEARNING_FIXTURES} initialMedia={MYCASES_MEDIA_FIXTURES} audience="student"/></StudentWorkspaceChrome>;
  ...
  return <StudentWorkspaceChrome badge="MyCases" title="MyCases" description="Review cases and turn experience into reusable learning." compactOnMobile><MyCasesWorkspace initialCases={cases} initialItems={items} audience="student"/></StudentWorkspaceChrome>;
}
